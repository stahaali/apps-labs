...
export const CLASSIFIED_PLATFORM_CONTENT = {
  ...
  /** Bottom green CTA band — props passed to `CTASection` on /classified-platform */
  ctaBand: {
    title: "Starting A New Classified Platform? Let's Talk",
    lead:
      "Ready to launch your classified marketplace? Contact us today for a free consultation and project estimate. We help you build a scalable, high-performance platform tailored to your business model and user needs.",
    ctaLabel: "Start Your Classified App",
    leftBrandName: "Marketplace",
...
export const LOGISTICS_TRANSPORTATION_CONTENT = {
  ...
  banner: {
    ...
    image: "/assets/images-webp/our-portfolio/food-delivery/3.webp",
    imageAlt: "Logistics and delivery operations mobile apps",
  },
  overview: {
  ...
  /** Bottom green CTA band — props for `CTASection` on /logistics-transportation */
  ctaBand: {
    title: "Starting A New Project? Let's Talk",
    lead:
      "Ready to launch your logistics app? Contact us today for a free consultation and project estimate. We'll help you build a solution designed around your logistics operations and business goals.",
    ctaLabel: "Start Your Logistics App",
