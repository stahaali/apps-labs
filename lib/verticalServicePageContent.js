...
export const CLASSIFIED_PLATFORM_CONTENT = {
  ...
  banner: {
    ...
    image: "/assets/images-webp/our-portfolio/ecommerce/1.png",
  ...
  overview: {
    ...
    image: "/assets/images-webp/our-portfolio/ecommerce/3.png",
...
export const NUTRITION_PLATFORM_CONTENT = {
  ...
  banner: {
    ...
    image: "/assets/images-webp/our-portfolio/fitness/1.png",
  ...
  overview: {
    ...
    image: "/assets/images-webp/our-portfolio/fitness/3.png",
...
export const RIDE_BOOKING_APP_CONTENT = {
  ...
  banner: {
    ...
    image: "/assets/images-webp/banners/1.png",
  ...
  overview: {
    ...
    image: "/assets/images-webp/our-portfolio/food-delivery/2.png",
...
export const CHAUFFEUR_SERVICE_CONTENT = {
  ...
  banner: {
    ...
    image: "/assets/images-webp/our-portfolio/ecommerce/2.png",
  ...
  overview: {
    ...
    image: "/assets/images-webp/our-portfolio/ecommerce/4.png",
...
export const LOGISTICS_TRANSPORTATION_CONTENT = {
  ...
  banner: {
    ...
    image: "/assets/images-webp/our-portfolio/food-delivery/3.png",
  ...
  overview: {
    ...
    image: "/assets/images-webp/our-portfolio/food-delivery/4.png",
...
export const AUCTION_APP_CONTENT = {
  ...
  banner: {
    ...
    image: "/assets/images-webp/our-portfolio/ecommerce/5.png",
