...
const IMG = {
  hero: "/assets/images-webp/banners/1.webp",
  ops: "/assets/images-webp/v1/5.webp",
  platform: "/assets/images-webp/v1/02.webp",
  setup: "/assets/images-webp/v1/6.webp",
  fulfillment: "/assets/images-webp/v1/3.webp",
  marketing: "/assets/images-webp/v1/4.webp",
};
...
export const FOOD_DELIVERY_V1_SECTIONS = [
  {
    ...
    headline: {
      before: "Take All Of Your Restaurant ",
      highlight: "Operations",
      after: " in one place",
    },
    body:
      "UpMenu is a complete online ordering solution, offering restaurants all the tools needed from orders to delivery.",
    bullets: [
      "Save by up to 90% on third-party commissions",
      "Sell directly to your customers without a middleman",
      "Seamlessly manage your menu, orders, and delivery",
    ],
    cta: "Start Selling Food online",
    image: IMG.ops,
    imageLeft: true,
  },
  {
...
export const FOOD_DELIVERY_V1_GALLERY_SLIDER = {
  ...
  slides: [
    { src: "/assets/images-webp/food-business/01.webp", alt: "Restaurant ordering app — hero menu" },
    { src: "/assets/images-webp/food-business/2.webp", alt: "Restaurant ordering app — categories" },
    { src: "/assets/images-webp/food-business/3.webp", alt: "Restaurant ordering app — product detail" },
    { src: "/assets/images-webp/food-business/4.webp", alt: "Restaurant ordering app — listings" },
    { src: "/assets/images-webp/food-business/5.webp", alt: "Restaurant ordering app — menu" },
    { src: "/assets/images-webp/food-business/6.webp", alt: "Restaurant ordering app — browse" },
    { src: "/assets/images-webp/food-business/7.webp", alt: "Restaurant ordering app — dish view" },
    { src: "/assets/images-webp/food-business/8.webp", alt: "Restaurant ordering app — checkout" },
  ],
};
...
export const FOOD_DELIVERY_V1_MARKETING = {
  ...
  headline: {
    before: "Maximize customer value",
    highlight: "with automated upselling",
  },
  body:
  ...
  image: IMG.marketing,
  imageLeft: true,
  /** Light/white baked into asset — blend into section bg (see SplitFeature). */
  knockoutWhiteBackground: true,
  /** Smaller mockup in the split column */
  narrowSplitImage: true,
};
...
export const FOOD_DELIVERY_V1_EXCITING_FEATURES = {
  ...
  phoneFrame: "/assets/images-webp/food-business/mobile-image.webp",
  phoneScreens: [
