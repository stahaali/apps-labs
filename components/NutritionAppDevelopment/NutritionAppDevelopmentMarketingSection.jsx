...
import { NUTRITION_APP_DEVELOPMENT_MARKETING } from "@/lib/nutritionAppDevelopmentMarketing";
import pageStyles from "@/components/FoodDeliveryV1/FoodDeliveryV1.module.css";
import styles from "./NutritionAppDevelopmentMarketingSection.module.css";
...
export default function NutritionAppDevelopmentMarketingSection() {
  const {
    eyebrow,
    headlineLine1,
    headlineLine2,
    ...
    image,
    imageAlt,
  } = NUTRITION_APP_DEVELOPMENT_MARKETING;

  const headingId = "nutrition-marketing-heading";
  ...
  return (
    <section
      className={`${styles.marketingSection} nutritionMarketingSectionMobilePad40`}
      aria-labelledby={headingId}
    >
      <div className={`${pageStyles.inner} nutritionMarketingInnerFlush`}>
