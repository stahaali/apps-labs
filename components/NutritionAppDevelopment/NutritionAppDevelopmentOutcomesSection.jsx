...
import { NUTRITION_APP_DEVELOPMENT_OUTCOMES } from "@/lib/nutritionAppDevelopmentOutcomes";
import pageStyles from "@/components/FoodDeliveryV1/FoodDeliveryV1.module.css";
import styles from "./NutritionAppDevelopmentOutcomesSection.module.css";
...
export default function NutritionAppDevelopmentOutcomesSection() {
  const { eyebrow, headline, stats } = NUTRITION_APP_DEVELOPMENT_OUTCOMES;
  const headingId = "nutrition-outcomes-heading";

  return (
    <section
      className={`${styles.outcomesSection} nutritionOutcomesSectionMobilePad40`}
      aria-labelledby={headingId}
    >
      <div className={`${pageStyles.inner} nutritionOutcomesInnerFlush`}>
