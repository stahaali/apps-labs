...
import { NUTRITION_APP_DEVELOPMENT_OPERATIONS } from "@/lib/nutritionAppDevelopmentOperations";
import pageStyles from "@/components/FoodDeliveryV1/FoodDeliveryV1.module.css";
import styles from "./NutritionAppDevelopmentOperationsSection.module.css";
...
export default function NutritionAppDevelopmentOperationsSection() {
  const { eyebrow, headlineLines, body, bullets, cta, image } =
    NUTRITION_APP_DEVELOPMENT_OPERATIONS;

  const headingId = "nutrition-operations-heading";
  ...
  const imageBlock = (
    <div className={pageStyles.imageCard}>
      <div className={`relative w-full min-h-[200px] bg-transparent ${styles.mockupWrap}`}>
        <ImageWithSkeleton
          src={image}
          alt="Person using a tablet with nutrition plans and coaching dashboards"
          width={2000}
          height={1250}
  ...
  return (
    <section className={styles.section} aria-labelledby={headingId}>
      <div className={`${pageStyles.inner} nutritionOperationsInnerFlush`}>
        <div
