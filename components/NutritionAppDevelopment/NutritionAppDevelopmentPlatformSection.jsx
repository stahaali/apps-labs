...
import { NUTRITION_APP_DEVELOPMENT_PLATFORM } from "@/lib/nutritionAppDevelopmentPlatform";
import pageStyles from "@/components/FoodDeliveryV1/FoodDeliveryV1.module.css";
import styles from "./NutritionAppDevelopmentPlatformSection.module.css";
...
export default function NutritionAppDevelopmentPlatformSection() {
  const { eyebrow, headlineParts, body, bullets, cta, image } =
    NUTRITION_APP_DEVELOPMENT_PLATFORM;

  const headingId = "nutrition-platform-heading";
  ...
  const imageBlock = (
    <div className={`${pageStyles.imageCard} ${styles.imageCol}`}>
      ...
      >
        <ImageWithSkeleton
          src={image}
          alt="Nutrition platform mobile app mockups with meal plans and coaching flows"
          width={1600}
          height={1000}
  ...
  return (
    <section className={styles.section} aria-labelledby={headingId}>
      <div className={`${pageStyles.inner} nutritionPlatformInnerFlush`}>
