...
import { NUTRITION_APP_DEVELOPMENT_SETUP } from "@/lib/nutritionAppDevelopmentSetup";
import pageStyles from "@/components/FoodDeliveryV1/FoodDeliveryV1.module.css";
import localStyles from "./NutritionAppDevelopmentSetupSection.module.css";
...
export default function NutritionAppDevelopmentSetupSection() {
  const {
    eyebrow,
    headlineLine1,
    headlineGreen,
    ...
    image,
    imageAlt,
  } = NUTRITION_APP_DEVELOPMENT_SETUP;

  const headingId = "nutrition-free-setup-heading";
  ...
  return (
    <section
      className={`${localStyles.sectionShell} nutritionFreeSetupSection`}
      aria-labelledby={headingId}
    >
      <div
        className={`${pageStyles.inner} nutritionFreeSetupInnerFlush`}
      >
