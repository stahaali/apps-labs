...
import { FITNESS_APP_DEVELOPMENT_MARKETING } from "@/lib/fitnessAppDevelopmentMarketing";
import pageStyles from "@/components/FoodDeliveryV1/FoodDeliveryV1.module.css";
import styles from "./FitnessAppDevelopmentMarketingSection.module.css";
...
export default function FitnessAppDevelopmentMarketingSection() {
  const {
    eyebrow,
    headlineLine1,
    headlineLine2,
    ...
    cta,
    image,
  } = FITNESS_APP_DEVELOPMENT_MARKETING;

  const headingId = "fitness-marketing-heading";
  ...
  const imageBlock = (
    <div className={pageStyles.imageCard}>
      ...
      >
        <ImageWithSkeleton
          src={image}
          alt="Fitness app on phone mockups with workouts and member engagement screens"
          width={1600}
          height={1000}
