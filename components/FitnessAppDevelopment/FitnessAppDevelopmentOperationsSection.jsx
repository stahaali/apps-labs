...
import { FITNESS_APP_DEVELOPMENT_OPERATIONS } from "@/lib/fitnessAppDevelopmentOperations";
import pageStyles from "@/components/FoodDeliveryV1/FoodDeliveryV1.module.css";
import styles from "./FitnessAppDevelopmentOperationsSection.module.css";
...
export default function FitnessAppDevelopmentOperationsSection() {
  const { eyebrow, headlineLines, body, bullets, cta, image } =
    FITNESS_APP_DEVELOPMENT_OPERATIONS;

  const headingId = "fitness-operations-heading";
