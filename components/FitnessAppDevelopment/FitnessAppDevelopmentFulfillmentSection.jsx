...
import { FITNESS_APP_DEVELOPMENT_FULFILLMENT } from "@/lib/fitnessAppDevelopmentFulfillment";
import pageStyles from "@/components/FoodDeliveryV1/FoodDeliveryV1.module.css";
import styles from "./FitnessAppDevelopmentFulfillmentSection.module.css";
...
export default function FitnessAppDevelopmentFulfillmentSection() {
  const {
    eyebrow,
    headlineLines,
    body,
    ...
    imageAlt,
    chips,
  } = FITNESS_APP_DEVELOPMENT_FULFILLMENT;

  const headingId = "fitness-fulfillment-heading";
