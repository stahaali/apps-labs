/**
 * Compact marks for fitness / wellness integration pills (stylized, not official logos).
 */

export default function FitnessAppDevelopmentIntegrationIcon({ id, className = "" }) {
