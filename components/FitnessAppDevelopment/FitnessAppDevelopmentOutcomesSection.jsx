...
import { FITNESS_APP_DEVELOPMENT_OUTCOMES } from "@/lib/fitnessAppDevelopmentOutcomes";
import pageStyles from "@/components/FoodDeliveryV1/FoodDeliveryV1.module.css";
import styles from "./FitnessAppDevelopmentOutcomesSection.module.css";
...
export default function FitnessAppDevelopmentOutcomesSection() {
  const { eyebrow, headline, stats } = FITNESS_APP_DEVELOPMENT_OUTCOMES;
