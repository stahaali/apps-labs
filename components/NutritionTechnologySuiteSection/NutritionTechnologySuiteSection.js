...
import styles from "./NutritionTechnologySuiteSection.module.css";
...
export default function NutritionTechnologySuiteSection() {
  return (
    <section
      className={`relative w-full overflow-x-clip ${styles.nutritionTechnologySuite} nutritionTechnologySuiteSection nutritionTechnologySuiteMobileFlushTop`}
      aria-labelledby="nutrition-technology-suite-heading"
    >
      ...
      <div className="mx-auto max-w-[980px] text-center">
        ...
        <h2 id="nutrition-technology-suite-heading" className="title text-balance text-neutral-900">
          Elevate Your Nutrition Brand <span className="text-[#70AA26]">with Our Tech Tools</span>
        </h2>
        <p className="mx-auto mt-5 max-w-[640px] text-[15px] leading-relaxed text-neutral-600 sm:text-[16px]">
          Grow member trust and coach throughput with a nutrition stack built for real-world constraints—adherence, subscriptions,
          multi-party visibility, and integrations your clinical and ops teams already depend on.
        </p>
      </div>
