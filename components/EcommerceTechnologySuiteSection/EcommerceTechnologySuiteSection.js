...
export default function EcommerceTechnologySuiteSection() {
  return (
    ...
    >
      ...
      <AnimateOnView variant="fadeUp" className="mx-auto max-w-[980px] text-center">
        ...
        <h2
          id="ecommerce-technology-suite-heading"
          className="title text-balance text-neutral-900"
        >
          Get the most out of your ecommerce business with{" "}
          <span className="text-[#70AA26]">
            our smart, effective, and economical solutions.
          </span>
        </h2>
