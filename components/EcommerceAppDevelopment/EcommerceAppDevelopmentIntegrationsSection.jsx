...
import {
  ECOMMERCE_APP_DEVELOPMENT_INTEGRATIONS,
  ECOMMERCE_INTEGRATION_ROW1,
  ECOMMERCE_INTEGRATION_ROW2,
} from "@/lib/ecommerceAppDevelopmentIntegrations";
...
export default function EcommerceAppDevelopmentIntegrationsSection() {
  const { subtitle, headline } = ECOMMERCE_APP_DEVELOPMENT_INTEGRATIONS;
    ...
    >
      <div className={pageStyles.inner}>
        <header className="mx-auto max-w-[900px] text-center">
          ...
          <h2
            id="ecommerce-integrations-heading"
      ...
      <div className={pageStyles.integrationsMarqueeBleed}>
        ...
        >
          <IntegrationMarqueeRow items={ECOMMERCE_INTEGRATION_ROW1} reverse={false} />
          <IntegrationMarqueeRow items={ECOMMERCE_INTEGRATION_ROW2} reverse />
        </div>
      </div>
    </section>
  );
