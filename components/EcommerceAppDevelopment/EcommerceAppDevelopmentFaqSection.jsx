...
import { ECOMMERCE_APP_DEVELOPMENT_FAQ } from "@/lib/ecommerceAppDevelopmentFaq";

/**
 * Lavender FAQ band — matches Food Delivery V1 FAQ rhythm (gradient, 720px accordion).
 */
      ...
      <div className="mx-auto max-w-[1200px] px-4 min-[480px]:px-6 sm:px-8 lg:px-10">
        <header className="mx-auto max-w-[900px] text-center">
          ...
          <p className="mx-auto mt-5 max-w-[640px] text-[15px] leading-relaxed text-neutral-600 sm:text-[16px]">
            Clear answers on launching, scaling, and what belongs in a modern e-commerce platform.
          </p>
        </header>

        <div className="mx-auto mt-12 max-w-[720px] max-[576px]:mx-[15px] sm:mt-14 lg:mt-16">
          <ContactFaq items={ECOMMERCE_APP_DEVELOPMENT_FAQ} />
        </div>
      </div>
    </section>
  );
