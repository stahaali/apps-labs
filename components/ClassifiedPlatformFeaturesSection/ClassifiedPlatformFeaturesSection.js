...
const FEATURE_ITEMS = [
  ...
  },
  {
    ...
    description:
      "Connect PSPs, maps, CRM, email, SMS, search, and webhooks so listings, offers, and payouts run as one stack—not a patchwork.",
  },
  {
    title: "Exceptional UI/UX",
    description:
      "Interfaces buyers and sellers actually finish—clear listing detail, fast filters, accessible flows, and trust cues where they matter.",
  },
  {
    title: "Dedicated Support",
    description:
      "Expert support through launch, category expansions, and traffic spikes when moderation and payments need steady hands.",
  },
  {
    title: "100% Customized Solution",
    description:
      "Tailored to your niche, branding, fee model, and how you verify sellers, handle disputes, and grow categories over time.",
  },
  {
    title: "Highly Robust & Scalable Solution",
    description:
      "Built for growing inventory, media-heavy listings, and peak-season traffic without sacrificing search speed or checkout reliability.",
  },
];
...
export default function ClassifiedPlatformFeaturesSection() {
  return (
    <section
      id="classified-platform-features"
      className={styles.ClassifiedPlatformFeaturesSection}
      aria-labelledby="classified-platform-features-heading"
    >
      <div className="mx-auto max-w-[1280px] px-6 sm:px-10 lg:px-14">
        <div className={`sections-surface1 rounded-[28px] px-6 py-12 sm:px-10 sm:py-14 lg:px-14 lg:py-16 ${styles.innercontainer}`}>
          <header className="mx-auto max-w-[1000px] text-center">
            ...
            <h2 id="classified-platform-features-heading" className="title text-balance text-neutral-900">
            ...
            <p className="mx-auto mt-5 max-w-[640px] text-[15px] leading-relaxed text-neutral-600 sm:text-[16px]">
              Explore capabilities that elevate your marketplace—from discovery and trust to messaging, monetization, and admin
