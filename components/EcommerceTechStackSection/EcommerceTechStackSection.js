...
export default function EcommerceTechStackSection() {
  ...
  return (
    <section
      className={styles.ecommerceTechStack}
      aria-labelledby="ecommerce-tech-stack-heading"
    >
      ...
      <div className={`${styles.inner} relative z-10`}>
        <header className="mx-auto max-w-[1020px] text-center">
          ...
          <h2
            id="ecommerce-tech-stack-heading"
