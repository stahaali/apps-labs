...
import { AUCTION_APP_DEVELOPMENT_PLATFORM } from "@/lib/auctionAppDevelopmentPlatform";
import pageStyles from "@/components/FoodDeliveryV1/FoodDeliveryV1.module.css";
import styles from "./AuctionAppDevelopmentPlatformSection.module.css";
...
export default function AuctionAppDevelopmentPlatformSection() {
  const { eyebrow, headlineParts, body, bullets, cta, image } =
    AUCTION_APP_DEVELOPMENT_PLATFORM;

  const headingId = "auction-platform-heading";
  ...
  return (
    <section className={styles.section} aria-labelledby={headingId}>
      <div className={`${pageStyles.inner} auctionPlatformInnerFlush`}>
