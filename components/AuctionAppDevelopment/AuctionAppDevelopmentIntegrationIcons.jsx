/**
 * Compact marks for auction / commerce integration pills (stylized, not official logos).
 */

export default function AuctionAppDevelopmentIntegrationIcon({ id, className = "" }) {
