...
import { AUCTION_APP_DEVELOPMENT_OUTCOMES } from "@/lib/auctionAppDevelopmentOutcomes";
import pageStyles from "@/components/FoodDeliveryV1/FoodDeliveryV1.module.css";
import styles from "./AuctionAppDevelopmentOutcomesSection.module.css";
...
export default function AuctionAppDevelopmentOutcomesSection() {
  const { eyebrow, headline, stats } = AUCTION_APP_DEVELOPMENT_OUTCOMES;
  const headingId = "auction-outcomes-heading";

  return (
    <section
      className={`${styles.outcomesSection} auctionOutcomesSectionMobilePad40`}
      aria-labelledby={headingId}
    >
      <div className={`${pageStyles.inner} auctionOutcomesInnerFlush`}>
