...
import { LOGISTICS_TRANSPORTATION_FULFILLMENT } from "@/lib/logisticsTransportationFulfillment";
import pageStyles from "@/components/FoodDeliveryV1/FoodDeliveryV1.module.css";
import styles from "./LogisticsTransportationFulfillmentSection.module.css";
...
export default function LogisticsTransportationFulfillmentSection() {
  const {
    eyebrow,
    headlineLines,
    body,
    ...
    imageAlt,
    chips,
  } = LOGISTICS_TRANSPORTATION_FULFILLMENT;

  const headingId = "logistics-fulfillment-heading";
  ...
  return (
    <section
      className={`${styles.section} logisticsFulfillmentSection`}
      aria-labelledby={headingId}
    >
      <div className={`${pageStyles.inner} logisticsFulfillmentInnerFlush`}>
