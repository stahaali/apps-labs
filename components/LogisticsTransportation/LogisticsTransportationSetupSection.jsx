...
import { LOGISTICS_TRANSPORTATION_SETUP } from "@/lib/logisticsTransportationSetup";
import pageStyles from "@/components/FoodDeliveryV1/FoodDeliveryV1.module.css";
import localStyles from "./LogisticsTransportationSetupSection.module.css";
...
function ChipIcon({ name }) {
  ...
  if (name === "truck") {
    return (
      <svg {...svgProps}>
        <path
          d="M3 13h9v4H3v-4Zm9 0h2l3 3v3h-5v-6Z"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <circle cx="7.5" cy="18.5" r="1.75" stroke="currentColor" strokeWidth="1.5" />
        <circle cx="17" cy="18.5" r="1.75" stroke="currentColor" strokeWidth="1.5" />
        <path d="M12 13V9h2.5L16 11v2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    );
  }
  if (name === "clipboard") {
    return (
      <svg {...svgProps}>
        <path
          d="M9 4h6a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H9m0-16H7a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h2"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path d="M10 4V3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v1M10 9h4M10 12h4M10 15h2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    );
  }
  if (name === "steering") {
    return (
      <svg {...svgProps}>
        ...
        <path d="M12 5v2M12 17v2M5 12h2M17 12h2M6.5 6.5l1.4 1.4M16.1 16.1l1.4 1.4M6.5 17.5l1.4-1.4M16.1 7.9l1.4-1.4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    );
  }
  if (name === "dumbbell") {
...
export default function LogisticsTransportationSetupSection() {
  const {
    eyebrow,
    headlineLine1,
    headlineGreen,
    ...
    imageAlt,
    chips,
  } = LOGISTICS_TRANSPORTATION_SETUP;

  const headingId = "logistics-free-setup-heading";
  ...
  return (
    <section
      className={`${localStyles.sectionShell} logisticsFreeSetupSection`}
      aria-labelledby={headingId}
    >
      <div
        className={`${pageStyles.inner} logisticsFreeSetupInnerFlush`}
      >
