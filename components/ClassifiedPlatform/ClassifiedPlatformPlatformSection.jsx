...
import { CLASSIFIED_PLATFORM_PLATFORM } from "@/lib/classifiedPlatformPlatform";
import pageStyles from "@/components/FoodDeliveryV1/FoodDeliveryV1.module.css";
import styles from "./ClassifiedPlatformPlatformSection.module.css";
...
export default function ClassifiedPlatformPlatformSection() {
  const { eyebrow, headlineParts, body, bullets, cta, image } =
    CLASSIFIED_PLATFORM_PLATFORM;

  const headingId = "classified-platform-heading";
  ...
  const imageBlock = (
    <div className={`${pageStyles.imageCard} ${styles.imageCol}`}>
      ...
      >
        <ImageWithSkeleton
          src={image}
          alt="Classified marketplace mobile mockups: listings, search filters, chat, and seller dashboard"
          width={1600}
          height={1000}
  ...
  return (
    <section className={styles.section} aria-labelledby={headingId}>
      <div className={`${pageStyles.inner} classifiedPlatformInnerFlush`}>
