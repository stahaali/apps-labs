...
import { CLASSIFIED_PLATFORM_SETUP } from "@/lib/classifiedPlatformSetup";
...
export default function ClassifiedPlatformSetupSection() {
  const {
    eyebrow,
    headlineLine1,
    headlineGreen,
    ...
    imageAlt,
    chips,
  } = CLASSIFIED_PLATFORM_SETUP;

  const headingId = "classified-free-setup-heading";
  ...
  return (
    <section
      className={`${localStyles.sectionShell} classifiedFreeSetupSection`}
      aria-labelledby={headingId}
    >
      <div
        className={`${pageStyles.inner} classifiedFreeSetupInnerFlush`}
      >
