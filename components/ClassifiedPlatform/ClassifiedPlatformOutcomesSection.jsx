...
import { CLASSIFIED_PLATFORM_OUTCOMES } from "@/lib/classifiedPlatformOutcomes";
import pageStyles from "@/components/FoodDeliveryV1/FoodDeliveryV1.module.css";
import styles from "./ClassifiedPlatformOutcomesSection.module.css";
...
export default function ClassifiedPlatformOutcomesSection() {
  const { eyebrow, headline, stats } = CLASSIFIED_PLATFORM_OUTCOMES;
  const headingId = "classified-outcomes-heading";

  return (
    <section
      className={`${styles.outcomesSection} classifiedOutcomesSectionMobilePad40`}
      aria-labelledby={headingId}
    >
      <div className={`${pageStyles.inner} classifiedOutcomesInnerFlush`}>
