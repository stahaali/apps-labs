...
import styles from "./ClassifiedPlatformOperationsSection.module.css";
...
export default function ClassifiedPlatformOperationsSection() {
  const { eyebrow, headlineLines, body, bullets, cta, image } =
    CLASSIFIED_PLATFORM_OPERATIONS;

  const headingId = "classified-operations-heading";
  ...
  const imageBlock = (
    <div className={pageStyles.imageCard}>
      ...
      >
        <ImageWithSkeleton
          src={image}
          alt="Operator reviewing classified listings, search, and moderation dashboards on a laptop"
          width={1600}
          height={1000}
