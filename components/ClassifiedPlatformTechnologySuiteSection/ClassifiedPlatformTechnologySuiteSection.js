...
export default function ClassifiedPlatformTechnologySuiteSection() {
  return (
    <section
      className={`relative w-full overflow-x-clip ${styles.classifiedTechnologySuite} classifiedTechnologySuiteSection classifiedTechnologySuiteMobileFlushTop`}
      aria-labelledby="classified-technology-suite-heading"
    >
